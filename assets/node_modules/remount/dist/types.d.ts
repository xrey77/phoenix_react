...
export declare type Component = React.ComponentClass<any, any> | React.FunctionComponent<any>;
...
export declare type ReactAdapter = Adapter;
...
export declare type Each = ((list: NodeList, fn: (item: Node) => any) => void) | (<T extends Element>(list: HTMLCollectionOf<T>, fn: (item: T) => any) => void) | ((list: HTMLCollection, fn: (item: HTMLElement) => any) => void);
